            ...
            <div className="fixed left-0 top-0 h-screen w-60 bg-white border-r border-slate-100 flex flex-col">
                ...
                <div className="p-4 border-t border-slate-100 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div onClick={handleLogout} className="text-sm text-slate-400 hover:text-red-500 cursor-pointer mt-1 transition-colors w-fit">Logout</div>
                    </div>
                </div>
            </div>
...
const StatCard = ({ icon, label, value, trend, trendColor, accentColor, TrendIcon, borderColor }) => (
    <div className={clsx("bg-white rounded-2xl p-6 border shadow-sm flex flex-col", borderColor)}>
